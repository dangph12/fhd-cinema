      ...
      <Card className="ticket-container">
        <Row className="g-2">
          ...
          <Col
            ...
            md={5}
            sm={12}
            className="text-center d-flex flex-column justify-content-center align-items-center ticket-left"
          >
          ...
          <Col
            ...
            md={7}
            sm={12}
            className="d-flex align-items-center ticket-right"
          >
            <Row className="w-100">
              ...
              <Col xs={12} md={8}>
                <Card.Body>
                  ...
                  <Card.Text className="movie-details-ticket">
                    📅 <strong>Ngày:</strong>{" "}
                    {new Date(showtimeDetails?.showtimeAt).toLocaleDateString(
                      "en-GB"
                    )}
                  </Card.Text>
                  <Card.Text className="movie-details-ticket">
                    ⏰ <strong>Suất chiếu:</strong>{" "}
                    {new Date(showtimeDetails?.showtimeAt).toLocaleTimeString(
                      "en-GB",
                  ...
                  <Card.Text className="movie-details-ticket">
                    📽️ <strong>Phòng chiếu:</strong>{" "}
                    {showtimeDetails?.screen?.screenName}
                  </Card.Text>
                  <hr />
